...
// Declare template
let indexTmpl = Template.Cash_inOutReport;
...
indexTmpl.onCreated(function () {
    ...
    this.autorun(() => {
        ...
        if (formDataState.get()) {
            ...
            // Check router name
            if (FlowRouter.getRouteName() == 'cash.inReport') {
                formData.cashType = 'In';
            } else if (FlowRouter.getRouteName() == 'cash.outReport') {
                formData.cashType = 'Out';
            }

            inOutReport.callPromise(formData)
                .then((result)=> {
...
AutoForm.addHooks('Cash_inOutReport', hooksObject);
